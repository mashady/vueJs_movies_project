        ...
        <div class="row g-4">
          ...
          <div class="col-md-8">
            ...
            <div class="mt-3">
              ...
              <span v-for="genre in tvShow.genres" :key="genre.id" class="badge text-light me-1">
                {{ genre.name }}
              </span>
            </div>
      ...
      <div v-if="cast.length" class="mt-5">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-4">
          <div v-for="actor in cast.slice(0, 6)" :key="actor.cast_id" class="text-center" style="width: 120px">
            <img :src="getActorImage(actor.profile_path)" class="img-fluid rounded cast-image" :alt="actor.name"
